...
assert_contains "skills/executing-plans/SKILL.md" "When a milestone is complete and its validation gate passes, create one non-interactive git commit before starting the next milestone."
...
assert_not_contains "skills/executing-plans/SKILL.md" "milestone or phase"

assert_contains "skills/subagent-driven-development/SKILL.md" "When a milestone is complete, reviewed, and validated, create one non-interactive git commit before dispatching work for the next milestone."
...
assert_not_contains "skills/subagent-driven-development/SKILL.md" "milestone or phase"
